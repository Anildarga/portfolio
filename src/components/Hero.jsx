  ...
  return (
    <section id="hero" style={{
      ...
      <div>
        ...
        >
          {[
            { icon: <FaGithub />, url: 'https://github.com/Anildarga' },
            { icon: <FaLinkedin />, url: 'https://linkedin.com/in/anild3777' },
            { icon: <FaEnvelope />, url: 'mailto:anildarga3777@gmail.com' }
          ].map((item, i) => (
            <a
              key={i}
              href={item.url}
